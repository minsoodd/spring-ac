				...
				<div id="mypage">
					...
					<div class="eventList">
						<ul>
							...
							<li>
								<div class="img">
									<a href="event_view.do?bno=${bvo.bno}&page=${page}"><img src="images/img/sample_event.jpg" alt="진행중 이벤트" /></a>
								</div>
								<div class="txt">
									<div class="subject">${bvo.btitle}</div>
									<div class="day">이벤트 기간 : 2014-04-01 ~ 
